...
import kotlinx.android.synthetic.main.fragment_assign_subtask.*

class AssignSubtaskFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_assign_subtask, container, false)
        val button: Button = view.findViewById(R.id.button_assignSubtask)
        button.setOnClickListener {
            disposable =
                apiService.assignSubtask(
                    editText_projectId.text.toString().toInt()
                    ,editText_taskId.text.toString().toInt()
                    ,editText_subtaskId.text.toString().toInt()
